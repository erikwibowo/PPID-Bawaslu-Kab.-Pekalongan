...
<?php if ($content == "kategori-halaman") { ?>
	<div class="row">
        <div class="col-12">
        	<div class="card">
	            <div class="card-header">
	            ...
	            <div class="modal" id="modal-default">
					<div class="modal-dialog">
						<div class="modal-content">
							...
							<div class="modal-body">
								<form method="POST" action="<?= site_url('sysadmin/kategori-halaman/create') ?>" role="form">
									<div class="form-group">
										<label>Kategori Halaman</label>
										<input type="text" class="form-control" name="kategori_halaman" placeholder="Kategori Halaman">
									</div>
							</div>
							<div class="modal-footer justify-content-between">
								<button type="button" class="btn btn-default" data-dismiss="modal">Tutup</button>
            	...
            	<div class="card-body table-responsive">
            		<table class="table datatable table-bordered table-hover">
	                	...
	                	<tbody>
			                ...
			                <tr>
								<td><?= $no++ ?></td>
								<td><?= $key->kategori_halaman ?></td>
								<td><?= $key->slug_kategori_halaman ?></td>
								<td>
									<div class="btn-group pull-right">
										<a href="#" class="btn btn-sm btn-info" data-toggle="modal" data-target="#modal-edit-<?= $key->id_kategori_halaman ?>"><i class="fa fa-eye"></i></a>
										<a href="<?= site_url('sysadmin/kategori-halaman/delete/'.$key->id_kategori_halaman) ?>" onclick="return confirm('Apakah anda yakin akan menghpaus data ini?')" class="btn btn-sm btn-danger"><i class="fa fa-trash"></i></a>
									</div>
								</td>
			                </tr>
			                <!-- Modal Edit Data -->
				            <div class="modal" id="modal-edit-<?= $key->id_kategori_halaman ?>">
								<div class="modal-dialog">
									<div class="modal-content">
										<div class="modal-header">
											<h4 class="modal-title">Edit Data</h4>
										...
										<div class="modal-body">
											<form method="POST" action="<?= site_url('sysadmin/kategori-halaman/update') ?>" role="form">
												<div class="form-group">
													<label>Nama Kategori Halaman</label>
													<input type="text" value="<?= $key->kategori_halaman ?>" class="form-control" name="kategori_halaman" placeholder="Nama Kategori Halaman">
													<input type="hidden" name="id_kategori_halaman" value="<?= $key->id_kategori_halaman ?>">
												</div>
										</div>
										<div class="modal-footer justify-content-between">
											<button type="button" class="btn btn-default" data-dismiss="modal">Tutup</button>
...
<?php if ($content == "halaman") { ?>
	<div class="row">
        <div class="col-12">
        	<div class="card">
	            <div class="card-header">
					<div class="btn-group pull-right">
						<a href="<?= site_url('sysadmin/halaman/tambah') ?>" class="btn btn-success btn-sm"><i class="fas fa-plus"></i> Tambah</a>
					</div>
	            </div>
            	<!-- /.card-header -->
            	<div class="card-body table-responsive">
            		<table class="table datatable table-bordered table-hover">
	                	...
	                	<tbody>
			                ...
			                <tr>
								<td><?= $no++ ?></td>
								<td>
									<?php if (empty($key->thumb_halaman)){ ?>
										-
									<?php }else{ ?>
										<img src="<?= base_url() ?>files/halaman/thumb/<?= $key->thumb_halaman ?>">
									<?php } ?>
								</td>
								<td><?= $key->kategori_halaman ?></td>
								<td><?= $key->judul_halaman ?></td>
								<td><?= $key->nama_admin ?></td>
								<td>
								...
								<td>
									<div class="btn-group pull-right">
										<a href="<?= site_url('sysadmin/halaman/edit/'.$key->id_halaman) ?>" class="btn btn-sm btn-info"><i class="fa fa-eye"></i></a>
										<a href="<?= site_url('sysadmin/halaman/delete?id='.$key->id_halaman.'&foto='.$key->foto_halaman.'&thumb='.$key->thumb_halaman) ?>" onclick="return confirm('Apakah anda yakin akan menghpaus data ini?')" class="btn btn-sm btn-danger"><i class="fa fa-trash"></i></a>
									</div>
								</td>
			                </tr>
			                <?php endforeach ?>
...
<?php if ($content == "kategori-informasi") { ?>
	<div class="row">
        <div class="col-12">
        	<div class="card">
	            <div class="card-header">
	            ...
	            <div class="modal" id="modal-default">
					<div class="modal-dialog">
						<div class="modal-content">
							...
							<div class="modal-body">
								<form method="POST" action="<?= site_url('sysadmin/kategori-informasi/create') ?>" role="form">
									<div class="form-group">
										<label>Kategori Informasi</label>
										<input type="text" class="form-control" required name="kategori_informasi" placeholder="Kategori Informasi">
									</div>
							</div>
							<div class="modal-footer justify-content-between">
								<button type="button" class="btn btn-default" data-dismiss="modal">Tutup</button>
            	...
            	<div class="card-body table-responsive">
            		<table class="table datatable table-bordered table-hover">
	                	...
	                	<tbody>
			                ...
			                <tr>
								<td><?= $no++ ?></td>
								<td><?= $key->kategori_informasi ?></td>
								<td><?= $key->slug_kategori_informasi ?></td>
								<td>
									<div class="btn-group pull-right">
										<a href="#" class="btn btn-sm btn-info" data-toggle="modal" data-target="#modal-edit-<?= $key->id_kategori_informasi ?>"><i class="fa fa-eye"></i></a>
										<a href="<?= site_url('sysadmin/kategori-informasi/delete/'.$key->id_kategori_informasi) ?>" onclick="return confirm('Apakah anda yakin akan menghpaus data ini?')" class="btn btn-sm btn-danger"><i class="fa fa-trash"></i></a>
									</div>
								</td>
			                </tr>
			                <!-- Modal Edit Data -->
				            <div class="modal" id="modal-edit-<?= $key->id_kategori_informasi ?>">
								<div class="modal-dialog">
									<div class="modal-content">
										<div class="modal-header">
											<h4 class="modal-title">Edit Data</h4>
										...
										<div class="modal-body">
											<form method="POST" action="<?= site_url('sysadmin/kategori-informasi/update') ?>" role="form">
												<div class="form-group">
													<label>Nama Kategori Informasi</label>
													<input type="text" value="<?= $key->kategori_informasi ?>" class="form-control" name="kategori_informasi" placeholder="Nama Kategori Informasi">
													<input type="hidden" name="id_kategori_informasi" value="<?= $key->id_kategori_informasi ?>">
												</div>
										</div>
										<div class="modal-footer justify-content-between">
											<button type="button" class="btn btn-default" data-dismiss="modal">Tutup</button>
	            ...
	            <div class="modal" id="modal-default">
					<div class="modal-dialog">
						<div class="modal-content">
							...
							<div class="modal-body">
								<form method="POST" action="<?= site_url('sysadmin/informasi/create') ?>" role="form">
									<div class="form-group">
										<label>Kategori Informasi</label>
										<select class="form-control select2" id="id_kategori_informasi" name="id_kategori_informasi" style="width: 100%">
											<?php foreach ($kategori as $k): ?>
												<option value="<?= $k->id_kategori_informasi ?>"><?= $k->kategori_informasi ?></option>
											<?php endforeach ?>
										</select>
									</div>
									<div class="form-group">
										<label>Informasi</label>
										<input type="text" class="form-control" required name="nama_informasi" placeholder="Judul Informasi">
									</div>
									<div class="form-group">
										<label>Link Informasi</label>
										<input type="text" class="form-control" required name="link_informasi" placeholder="Link Informasi">
									</div>
							</div>
							<div class="modal-footer justify-content-between">
								<button type="button" class="btn btn-default" data-dismiss="modal">Tutup</button>
            		...
            		<table class="table datatable table-bordered table-hover">
	                	...
	                	<tbody>
			                ...
			                <tr>
								<td><?= $no++ ?></td>
								<td><?= $key->kategori_informasi ?></td>
								<td><?= $key->nama_informasi ?></td>
								<td><?= $key->unduhan_informasi ?></td>
								<td><a target="_blank" href="<?= $key->link_informasi ?>"><?= $key->link_informasi ?></a></td>
								<td>
									<div class="btn-group pull-right">
										<a href="#" class="btn btn-sm btn-info" data-toggle="modal" data-target="#modal-edit-<?= $key->id_informasi ?>"><i class="fa fa-eye"></i></a>
										<a href="<?= site_url('sysadmin/informasi/delete/'.$key->id_informasi) ?>" onclick="return confirm('Apakah anda yakin akan menghpaus data ini?')" class="btn btn-sm btn-danger"><i class="fa fa-trash"></i></a>
									</div>
								</td>
			                </tr>
			                <!-- Modal Edit Data -->
				            <div class="modal" id="modal-edit-<?= $key->id_informasi ?>">
								<div class="modal-dialog">
									<div class="modal-content">
										<div class="modal-header">
											<h4 class="modal-title">Edit Data</h4>
										...
										<div class="modal-body">
											<form method="POST" action="<?= site_url('sysadmin/informasi/update') ?>" role="form">
												<div class="form-group">
													<label>Kategori Informasi</label>
													<select class="form-control select2" id="id_kategori_informasi" name="id_kategori_informasi" style="width: 100%">
														<?php foreach ($kategori as $k): ?>
															<option <?= $k->id_kategori_informasi == $key->id_kategori_informasi ? "selected":"" ?> value="<?= $k->id_kategori_informasi ?>"><?= $k->kategori_informasi ?></option>
														<?php endforeach ?>
													</select>
												</div>
												<div class="form-group">
													<label>Informasi</label>
													<input type="text" class="form-control" required name="nama_informasi" placeholder="Kategori Informasi" value="<?= $key->nama_informasi ?>">
												</div>
												<div class="form-group">
													<label>Link Informasi</label>
													<input type="text" class="form-control" required name="link_informasi" placeholder="Link Informasi" value="<?= $key->link_informasi ?>">
													<input type="hidden" name="id_informasi" value="<?= $key->id_informasi ?>">
												</div>
										</div>
										<div class="modal-footer justify-content-between">
											<button type="button" class="btn btn-default" data-dismiss="modal">Tutup</button>
